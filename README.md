...
- Una **pieza extra de reto: la Tuerca (N)**, un bloque 3×3 acero con el centro vacío. Al fijarse deja un agujero que solo se puede rellenar deslizando otra pieza por un lateral.
